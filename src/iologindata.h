...
class IOLoginData
{
	public:
		...
		static bool loginserverAuthentication(uint32_t name, const std::string& password, Account& account);
		static uint32_t gameworldAuthentication(uint32_t name, const std::string& password, std::string& characterName);
